...
class TaskPriorityAttribute implements TaskAttribute {
    ...
    {
        Multimap<Priority, String> availableActions =  ArrayListMultimap.create();
    ...
    private void addMapToMultiMap(final Map<Priority, Collection<String>> map, Multimap<Priority, String> availableActions) {
...
class TaskDateAttribute implements TaskAttribute {
    ...
    private String getDateText(String arguments, List<DateGroup> dateGroups) 
    {
        ...
        return arguments.replaceFirst(dateText, "-");
    }
