...
/**
 * @author Andy Hsu Wei Qiang This class handles all the GUI logic Main which the
 *         user execute.
 */
public class UserInterfaceMain {	
	private static final String DATE_FORMAT = "dd/MM/yyyy";
	private static final String VIEW_TODAY_STRING = "You are viewing today tasks.";
	private static final String VIEW_TOMORROW_STRING = "You are viewing tomorrow tasks.";
	private static final String VIEW_YESTERDAY_STRING = "You are viewing yesterday tasks.";
	private static final SimpleDateFormat sdf = new SimpleDateFormat(DATE_FORMAT);
	private static final int taskbarHeight = 40;
	
	/**
	 * This operation initialize all the GUI Processes 
	 */
	public static void initProcess() {
		...
		UserIntSwing.lblTodayDate.setText(VIEW_TODAY_STRING);
	 ...
	 */
	private static void setStartEndDate(Task task) {
		...
		if(dateView.matches(todayAsString)) {
			UserIntSwing.lblTodayDate.setText(VIEW_TODAY_STRING);
		}else if(dateView.matches(tomorrowAsString)){
			UserIntSwing.lblTodayDate.setText(VIEW_TOMORROW_STRING);
		}else if(dateView.matches(yesterdayAsString)){
			UserIntSwing.lblTodayDate.setText(VIEW_YESTERDAY_STRING);
		}
	}
	...
	private static void processTextfieldString() {
		...
		UserIntSwing.lblHelp.setText(
				CommandGuide.buildGeneralGuideString());
	}
